...
.table-spsns p{     margin-bottom: 0px;
}
.table-spsns thead {
}
.table-spsns thead td{ background: #fff4f4;
    font-weight: 690;
}
.table-spsns tbody{
}
.table-spsns tbody td{
}
...
<div class="table-spsns">
<table border="0" cellspacing="0" cellpadding="0" style="100%">
<thead>
  <tr>
    <td width="263" valign="top"> </td>
    <td style="background: linear-gradient(-72deg, #dedede, #ffffff 16%, #dedede 21%, #ffffff 24%, #caa1de 27%, #dea1ca 30%, #dedede 38%, #ffffff 45%, #ffffff 60%, #dedede 72%, #ffffff 80%, #dedede 84%, #caa1de 93%, #dea1ca);
    color: #fff !important;" valign="top"> <p style="color:#fff">TITANIUM </p></td>
    <td width="64" valign="top" style="background: linear-gradient(-72deg, #dedeff, #ffffff 16%, #dedeff 21%, #ffffff 24%, #555564 27%, #dedeff 36%, #ffffff 45%, #ffffff 60%, #dedeff 72%, #ffffff 80%, #dedeff 84%, #555564);"><p>PLATINUM </p></td>
    <td width="64" valign="top" style="    background: linear-gradient(#ffffff, #e3e3e3);"><p>DIAMOND </p></td>
    <td width="64" valign="top" style="background: linear-gradient(-72deg, #ffdea1, #ffffff 16%, #ffdea1 21%, #ffffff 24%, #736445 27%, #ffdea1 36%, #ffffff 45%, #ffffff 60%, #ffdea1 72%, #ffffff 80%, #ffdea1 84%, #736445);"><p>GOLD </p></td>
    <td width="65" valign="top" style="    background: linear-gradient(-72deg, #dedede, #ffffff 16%, #dedede 21%, #ffffff 24%, #454545 27%, #dedede 36%, #ffffff 45%, #ffffff 60%, #dedede 72%, #ffffff 80%, #dedede 84%, #a1a1a1);"><p>SILVER </p></td>
    <td width="63" valign="top"><p>BRONZE </p></td>
  </tr>
  </thead>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Outsidehalllargestall(premiumlocation) </p></td>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Outsidehalllargestall(frontlocation) </p></td>
    <td width="67" valign="top"> </td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> 
        <p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Outsidehallregularstall(middlelocation) </p></td>
    <td width="67" valign="top"> </td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> 
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Outsidehallregularstall </p></td>
    <td width="67" valign="top"> </td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> </td>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Registrationof companyexecutive </p></td>
    <td width="67" valign="top"> 
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Dedicatedloungespaceforcompany </p></td>
    <td width="67" valign="top"> 
        <p align="center">y </p></td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> </td>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Companylogoinwebsitewithlink </p></td>
    <td width="67" valign="top"> 
        <p align="center">y </p></td>
    <td width="64" valign="top"> 
        <p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Companylogoinwebsitewithoutlink </p></td>
    <td width="67" valign="top"> </td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> </td>
    <td width="64" valign="top"> 
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Companylogoinflierandnewsletter </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="65" valign="top"><p align="center">y </p></td>
    <td width="63" valign="top"><p align="center">y </p></td>
  </tr>
  <tr>
    <td width="263" valign="top"> 
        <p>CompanynameandlogoinPreliminaryandfinalprogram </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"><p>In-hallbranding </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"> </td>
  ...
  <tr>
    <td width="263" valign="top"><p>Companynameandlogoinannouncements </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"><p>Separate    IndividualSignageatentrance    totheMainHall </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"><p>Specialthankstoheadofsponsoratmeeting </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"><p>Signageinsidemainconferencehall </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"> </td>
  ...
  <tr>
    <td width="263" valign="top"><p>Electronic registrationdataofattendees </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"><p>Electroniclistofattendees    postconference </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"><p>Adequatementionduringthelectureandinprogram </p></td>
    <td width="67" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
    <td width="64" valign="top"><p align="center">y </p></td>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Dedicatedscientificlecture </p></td>
    <td width="67" valign="top"> 
        <p align="center">3 </p></td>
    <td width="64" valign="top"> 
        <p align="center">2 </p></td>
  ...
  <tr>
    <td width="263" valign="top"> 
        <p>Permission&nbsp; forsouvenirofVAICON2023with logo </p></td>
    <td width="67" valign="top"> 
        <p align="center">y </p></td>
    <td width="64" valign="top"> 
        <p align="center">y </p></td>
